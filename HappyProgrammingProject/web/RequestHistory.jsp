            ...
            <jsp:include page="header.jsp"></jsp:include>
                ...
                <section class="vh-100 mt-5 py-5 px-5">
                    <div class="container-fluid h-custom">
                        ...
                        <c:choose>
                            <c:when test="${RequestHistoryList == null}">
                            ...
                            <c:otherwise>
                                <div class="col-md-4 col-lg-4 col-xl-4 offset-xl-1">
                                    <h2 class="text-start text-primary fw-bold">Request History</h2>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-4 offset-xl-1">
                                    <form class="d-flex my-1 mx-lg-1" action="RequestHistorySearch" method="post">                       
                                        <input value="" class="form-control me-2" name="key" type="search" placeholder="Search Request History ..." aria-label="Search">
                                ...
                                <table class="table table-striped mt-4">
                                    ...
                                    <tbody>
                                        <c:forEach items="${RequestHistoryList}" var="r">
                                            <tr>
